...
class HorizontalScrollView: UIView {
    ...
    var title_NorColor: UIColor = UIColor.white
    var title_SelectColor: UIColor = UIColor.black
    ...
    var titles: NSMutableArray! {
        ...
        didSet{
            ...
            for i in 0..<titles.count {
                ...
                btn.frame = CGRect(x:  CGFloat(i) * (item_Width + CGFloat(btnSpace) ) + CGFloat(btnSpace), y: 0, width: item_Width, height: self.itemScrollView.frame.size.height)
